    ...
    if (parametr == 'init'):
        ...
        with db:
            clients = [
                ...
                {'name': 'Bran', 'city': 'Sanct-Peterburg',
                    'address': 'Lomonosova 67'},
                {'name': 'Aleksey', 'city': 'Nefteugansk',
                    'address': 'Dekabrisrov 15'}
            ]
        ...
        print("Введен не коректный параметр")


if __name__ == "__main__":
    print("Введите значение запроса:\t")
    parametr = input()
    db_job(parametr)
